...
```ts
import { Canvas, Circle, Group, Path, Rect, vec } from '@shopify/react-native-skia';
import { Stack } from 'expo-router';
import { StyleSheet, View } from 'react-native';
...
[![Image from Gyazo](https://i.gyazo.com/970183015f8428f323f1684c7d5958ef.png)](https://gyazo.com/970183015f8428f323f1684c7d5958ef)
...
[![Image from Gyazo](https://i.gyazo.com/7ab731e1f51b0ed37b2b939f58a3f29d.png)](https://gyazo.com/7ab731e1f51b0ed37b2b939f58a3f29d)
...
export default function SkiaTest() {
  ...
  const circleSize = CIRCLE_CONFIG.size;
  ...
  useEffect(() => {
    progress.value = withRepeat(
      withTiming(circleSize * 0.5, { duration: ANIMATE_CIRCLE_CONFIG.duration }),
      -1
    );
  }, [progress, circleSize]);
...
[![Image from Gyazo](https://i.gyazo.com/7db0d188bb1b7179e8401015d9bf2fa5.gif)](https://gyazo.com/7db0d188bb1b7179e8401015d9bf2fa5)
